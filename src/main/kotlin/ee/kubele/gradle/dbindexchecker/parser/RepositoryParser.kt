...
object RepositoryParser {
	...
	private val JOIN_ALIAS_KEYWORDS =
		setOf("on", "where", "inner", "left", "right", "outer", "cross", "natural", "join", "set")
	private val SQL_VALUE_KEYWORDS =
		setOf("null", "not", "true", "false", "and", "or", "exists", "select", "case", "when", "then", "else", "end")
